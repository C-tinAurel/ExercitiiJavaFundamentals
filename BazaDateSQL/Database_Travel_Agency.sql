...
flight_date_and_time_arriving varchar(30) ,
flight_date_and_time_departure varchar(30) not null,
price double not null,
available_seats int not null,
airports_arriving int ,
constraint fk_flights_airports_arriving
foreign key (airports_arriving)
references airports(id),
airports_departure int not null,
constraint fk_flights_airports_departure
foreign key (airports_departure)
references airports(id)
);
